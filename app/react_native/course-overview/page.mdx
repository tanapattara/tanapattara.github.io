...
นำบทเรียนทั้งหมดมาพัฒนา Campus Events Mobile แบบสะสมผลงาน ตั้งแต่ UI และ Navigation ไปจนถึง API, Offline, Authentication, Device Permissions, Testing และ Release Build

<Cards>
  <Cards.Card title="ดูรายละเอียด Milestones" href="/react_native/course-project" />
</Cards>
